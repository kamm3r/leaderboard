...
const pusherStore = (slug: string) => {
    ...
    const presenceChannel = pusher.subscribe(`presence-${slug}`) as PresenceChannel
    ...
    presenceChannelAtom.bind("pusher:subcription_succeeded", updateMembers)
    presenceChannelAtom.bind("pusher:member_added", updateMembers)
    presenceChannelAtom.bind("pusher:member_removed", updateMembers)
